# 1 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
# 1 "/opt/arduino-1.6.0//"
# 1 "<command-line>"
# 1 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
# 25 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
...
# 26 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c" 2
# 40 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
...
unsigned long micros() {
 unsigned long m;
 uint8_t oldSREG = (*(volatile uint8_t *)((0x3F) + 0x20)), t;

 __asm__ __volatile__ ("cli" ::: "memory");
 m = timer0_overflow_count;

 t = (*(volatile uint8_t *)((0x26) + 0x20));
# 97 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
 if (((*(volatile uint8_t *)((0x15) + 0x20)) & (1 << (0))) && (t < 255))
  m++;
...
void delayMicroseconds(unsigned int us)
{
# 152 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
 if (--us == 0)
  return;
 ...
 us -= 2;
# 184 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
...
void init()
{
 ...
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)((0x24) + 0x20)))))) |= (1 << (1)));
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)((0x24) + 0x20)))))) |= (1 << (0)));
# 214 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)((0x25) + 0x20)))))) |= (1 << (1)));
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)((0x25) + 0x20)))))) |= (1 << (0)));
# 228 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)(0x6E)))))) |= (1 << (0)));
# 239 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
 (*(volatile uint8_t *)(0x81)) = 0;


 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)(0x81)))))) |= (1 << (1)));

 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)(0x81)))))) |= (1 << (0)));
# 254 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)(0x80)))))) |= (1 << (0)));
# 263 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)(0xB1)))))) |= (1 << (2)));
# 272 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)(0xB0)))))) |= (1 << (0)));
# 309 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)(0x7A)))))) |= (1 << (2)));
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)(0x7A)))))) |= (1 << (1)));
 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)(0x7A)))))) |= (1 << (0)));


 ((*(volatile uint8_t *)(((uint16_t) &((*(volatile uint8_t *)(0x7A)))))) |= (1 << (7)));
# 323 "/opt/arduino-1.6.0/hardware/arduino/avr/cores/arduino/wiring.c"
